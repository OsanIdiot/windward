...
const files = new Set(['index.html', 'style.css', 'geography.js', 'navigation.js', 'engine.js', 'sea-ui.js', 'voyage-ui.js', 'audio-config.js', 'audio.js', 'app.js', 'assets/harbor-town.webp']);
