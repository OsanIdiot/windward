...
const files = new Set(['index.html', 'style.css', 'geography.js', 'navigation.js', 'engine.js', 'sea-ui.js', 'voyage-ui.js', 'audio.js', 'app.js', 'assets/harbor-town.webp']);
...
http.createServer((req, res) => {
  ...
  if (!files.has(requested)) { res.writeHead(404).end('Not found'); return; }
