...
async function openChart(page) {
  await page.waitForFunction(() => !document.getElementById('start-button').disabled && document.getElementById('page-transition').hidden && !document.getElementById('game-screen').hidden);
